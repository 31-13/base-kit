    ...
    <List className={classes.list}>
        ...
        <CustomDropdown
          ...
          dropdownList={[
            <Link href="/authors/Ricardo-Menotti">
              <a className={classes.dropdownLink}>R. Menotti</a>
            </Link>,
            <Link href="/authors/Julio-Iglesias">
              <a className={classes.dropdownLink}>J. Iglesias</a>
            </Link>,
            <Link href="/authors/Bruno-Mars">
              <a className={classes.dropdownLink}>Bruno Mars</a>
            </Link>,
            <Link href="/authors/Bad-Bunny">
      ...
      <ListItem className={classes.listItem}>
        <Button
          ...
          className={classes.navLink}
        >
          <PartyModeIcon className={classes.icons} />
          Hobbies
        </Button>
      </ListItem>
      <ListItem className={classes.listItem}>
